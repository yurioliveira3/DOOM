...
// Only the low 2 bits matter here, so truncating through a narrower type
// wouldn't actually be wrong -- but uintptr_t is the correct width and
// avoids the pointer-to-int warning.
